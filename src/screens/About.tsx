...
const About = ({ setScreen, onViewDetails }: Props) => (
  <div 
    style={{
      position: "relative",
      zIndex: 50,
  ...
  >
    ...
    <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: "var(--red)", letterSpacing: "0.3em", marginBottom: "0.5rem" }}>03 // PROFILE</div>
    <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.5rem, 6vw, 5rem)", color: "var(--white)", letterSpacing: "0.05em" }}>ABOUT ME</h2>
